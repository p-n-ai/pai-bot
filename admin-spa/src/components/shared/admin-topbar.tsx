...
export function AdminTopbar() {
  ...
  return (
    <header className='sticky top-3 z-20 mx-3 mt-3 flex min-h-14 items-center justify-between gap-3 rounded-2xl border border-[var(--admin-line)] bg-[color:var(--admin-surface)]/96 px-3 sm:mx-5 sm:px-5 md:hidden'>
