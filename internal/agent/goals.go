...
func quizOwnsConversation(conv *Conversation) bool {
	...
	if conv.State == conversationStateQuizIntensity || conv.State == conversationStateQuizActive {
		return true
	}
	return conv.QuizState != nil && conv.QuizState.RunState == quizRunStatePaused
}
