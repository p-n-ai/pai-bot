...
![AI Architecture Deep Dive](ai-architecture.svg)
...
| **Dynamic Question Generation** | Planned: generate quiz questions when curriculum has insufficient assessments | Planned future extension of `internal/agent/quiz.go` using `CompleteJSON` plus PT3/SPM exemplars. |
