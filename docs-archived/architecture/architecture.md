...
[P&AI Agent Core](agent-core.md) provides a native model → tool → model continuation loop without moving tutor policy, persistence, provider routing, or Telegram delivery into the core.
