...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2.5 rounded-2xl py-2 pr-8 pl-3 text-sm font-medium text-slate-950 outline-hidden select-none focus:bg-slate-100 focus:text-slate-950 not-data-[variant=destructive]:focus:**:text-slate-950 data-disabled:pointer-events-none data-disabled:opacity-50 dark:text-slate-100 dark:focus:bg-slate-900 dark:focus:text-slate-100 dark:not-data-[variant=destructive]:focus:**:text-slate-100 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
