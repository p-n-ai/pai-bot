...
const ShapeGrid: React.FC<ShapeGridProps> = ({
  ...
  }, [backgroundColor, borderColor, direction, fadeColor, hoverFillColor, hoverTrailAmount, shape, speed, squareSize]);

  return <canvas ref={canvasRef} className={cn("block size-full border-none", className)}></canvas>;
};
